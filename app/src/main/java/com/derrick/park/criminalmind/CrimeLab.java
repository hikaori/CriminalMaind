...
//        }
    ...
    private CrimeCursorWrapper queryCrimes(String whereClause, String[] whereArgs) {
        Cursor cursor = mDatabase.query(CrimeDbSchema.CrimeTable.NAME, null, // columns - null select all columns)
                whereClause, whereArgs, null, //groubBy
                null, //having
                null //orderBy
        );
